                            ...
                            <div className="w-full max-w-md">
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        onKeyDown={(e) => {
                                            if (e.key === "Enter") search.onEnter(search.value);
                                        }}
                                    />
                                    {search.value && (
                                        <button onClick={search.onClear} className="absolute right-2 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground">
                                            <X className="size-4" />
                                        </button>
                                    )}
                                </div>
